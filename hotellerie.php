					...
					<div class="row">
						<div class="col-sm-6">
							<div class="footer-content">
								<p class="large">Venez aussi découvrir nos magnifiques chambres d'hôtes ! Elles vous accueilleront avec simplicité et calme pour vous reposer. Vous, voyageurs fatigués comme les fins gourmets venez vous détendre à notre humble table.</p>
								<ul class="list-icons">
